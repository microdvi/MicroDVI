## Meanings of labels "C" and "N/U" in the ground truths.
+ ### "C": Common component
...
+ ### "N/U": Not used
    ...
    - Thus, like the common component, this paper does not care which microservice unused component is assigned to.